...
// Priority icon
export const PriorityIcon = ({ className = "w-6 h-6", priority = "medium" }) => {
  const getPathColor = () => {
    switch (priority) {
      case 'high':
        return 'text-red-500';
  ...
  return (
    <svg className={`${className} ${getPathColor()}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
